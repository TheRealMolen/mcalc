...
$(BUILD_DIR)/$(TARGET): $(OBJS) src/drivers/fonts/font-10x16.c
	$(CXX) $(OBJS) -o $@ $(LDFLAGS)
...
src/drivers/fonts/font-10x16.c: res/font-10x16.png res/font-10x16.layout.txt tools/packfont.py Makefile
